  ...
  function Selector (options) {
    ...
    _.build = function () {
      _.selector.each(function (i) {
        ...
        $(this).parent().append('<div class="select-head"></div>')
        $(this).parent().append('<ul class="select-list"></ul>');
        var opt = $(this).find('option');
        var ul = [];
        opt.each(function (i) {
          var wrap = opt.parent().parent().find('ul');
          var selectHead = opt.parent().parent().find('.select-head');
          ul.push($(this).text());
